...
class HabitAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HabitViewHolder {
        val inflater = LayoutInflater.from(parent.context).inflate(R.layout.habit_item, parent, false)
        return HabitViewHolder(inflater)
    }
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            val levelPriority = RandomHabitAdapter.PageType.valueOf(habit.priorityLevel.uppercase(
                Locale.ROOT))
            ivPriority.setImageResource(when(levelPriority) {
